...
Record the spec locator, base revision, and any prior coverage and arbitration records.
...
Give each reviewer the spec locator, base revision, assigned focus, relevant prior evidence, and check results; require it to retrieve the spec and complete diff itself.
...
Return reports by focus, coverage, base revision, and in-scope requirement or mandatory-rule violations separately from verification blockers.
