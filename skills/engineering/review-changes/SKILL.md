---
name: review-changes
description: Reviews current-branch code changes against the intent of an identified task, project conventions, and logic correctness.
---
...
Run the project's established current-branch diff command and capture the complete diff against its configured target.
