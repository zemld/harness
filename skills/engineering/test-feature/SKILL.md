...
Identify the approved target, spec locator, acceptance scope, and allowed side effects.
...
Give the tester the spec locator, not a retold spec.
...
Require the tester to read the spec directly and derive cases for every in-scope criterion.
